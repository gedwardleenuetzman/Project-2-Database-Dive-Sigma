...
/**
 * Provides the ability for the manager to get data from an inputted start/end
 * date
 */
public class RangedSalesGui extends JFrame {
	/**
	 * 
	 * @param gui       goes back to salesreportgui
	 * @param startDate start date that is input by the user to set the beggining
	 *                  point of which the report is retrieved
	 * @param endDate   end date that is input by the user to set the end point of
	 *                  which the report is retrieved
	 */
